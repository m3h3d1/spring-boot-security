...
import com.spring.securityPractice.model.LoginResponseDto;
...
//    }
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult) throws IOException, ServletException {
        ...
        // Create a LoginResponseDto with the necessary fields
        ...
        // Serialize the LoginResponseDto to JSON
        ObjectMapper objectMapper = new ObjectMapper();
        String responseJson = objectMapper.writeValueAsString(loginResponseDto);
